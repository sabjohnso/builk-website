...
Bilk Scheme supports hygienic macros via `syntax-rules`. Macros transform code at
...
Bilk Scheme's macros are hygienic: bindings introduced by a macro cannot conflict
